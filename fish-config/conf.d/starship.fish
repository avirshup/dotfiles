...
if type -q starship
    function fish_prompt
        ...
        starship prompt --terminal-width="$COLUMNS" --status=$STARSHIP_CMD_STATUS --pipestatus="$STARSHIP_CMD_PIPESTATUS" --keymap=default --cmd-duration=$STARSHIP_DURATION --jobs=$STARSHIP_JOBS
    ...
    function fish_right_prompt
        ...
        set STARSHIP_DURATION "$CMD_DURATION$cmd_duration"
        set STARSHIP_JOBS (count (jobs -p))
        starship prompt --right --terminal-width="$COLUMNS" --status=$STARSHIP_CMD_STATUS --pipestatus="$STARSHIP_CMD_PIPESTATUS" --keymap=default --cmd-duration=$STARSHIP_DURATION --jobs=$STARSHIP_JOBS
